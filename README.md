...
[bitty-workflow](https://github.com/bitty-terminal/bitty-workflow) as redacted
ctxpack snapshots, with `LATEST` naming the newest snapshot. A fresh clone can
restore its local CarryCtx DB from that mirror:
