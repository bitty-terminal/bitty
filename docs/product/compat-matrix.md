...
- Companion: [`compat-lab.md`](./compat-lab.md) (Phase C scaffold, CTX-0074), [`manual-smoke.md`](./manual-smoke.md) (human checklist, CTX-0087/0099), [`dogfooding.md`](./dogfooding.md) (daily-driver headless, CTX-0077), `crates/bitty-compat-lab` (owner, `forbid(unsafe)`, bounded 8 KiB/4096), `recordings/compat-matrix-2026-09-01.json` (machine-readable matrix, generated headlessly), `recording/references/bitty/*.snapshot.json` (39+ dumps via `collect_dumps`).
