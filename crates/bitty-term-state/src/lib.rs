...
//! | [`CANONICAL_HASH_VERSION`](canonical_public::CANONICAL_HASH_VERSION) | 8 | RFC replay guarantee 2 serialization version (evolution policy per RFC open item; v2 adds alt-screen saved cursor style/visibility, v3 adds per-cell combining buffers, v4 adds soft-wrap continuation flags for CTX-0266 reflow, v5 adds synchronized-update mode for CTX-0380, v6 adds the hyperlink id-space position for CTX-0490, v7 adds the alternate-scroll mode for CTX-0566, v8 adds the Kitty keyboard flag stack for CTX-0575) |
//!
//! # Determinism
//!
